# 59 Canonical Themes & Visual Catalog

`tmux-session-dock` includes 59 pre-configured, professionally tuned color themes conforming to the Canonical 3-Tier Taxonomy:
